...
│   │   │   ├── ArticleNode.tsx        # Full slug (break-words, no truncation) + inline headline/CTA editor (expand ▼); 📄 icon; new edges default CTA to "MORE"; no query subtext
