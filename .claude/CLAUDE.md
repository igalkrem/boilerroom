...
│   ├── performance/
│   │   ├── PerformanceSummaryTables.tsx # Three compact summary tables (By Article, By Feed, By Date) rendered between KpiSummaryBar and PerformanceTable; By Article and By Feed: Cost/Revenue/Profit/ROI + 1D-ago/2D-ago historical ROI; By Date: Cost/Revenue/Profit/ROI always showing last 30 days (last30Rows prop, independent of date picker); loads articles+providers from localStorage; empty feed_provider_id → "Visymo (KingsRoad)"
