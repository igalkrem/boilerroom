...
│   │   └── ColumnSelector.tsx         # Dropdown checklist to show/hide metric columns; 29 columns (raw + computed + snap_results/snap_cost_per_result/snap_purchase_value_usd); persists to localStorage (br_perf_cols)
│   ├── ui/
