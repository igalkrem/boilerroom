...
│   │   ├── CanvasControls.tsx         # Top bar: Auto-align, Review →; computeAutoLayout (dagre LR, ranksep 200) with post-processing sort to match upstream y-order and prevent tangled edges
│   │   ├── nodes/
