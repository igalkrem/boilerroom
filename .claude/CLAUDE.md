...
│   ├── performance/
│   │   ├── PerformanceSummaryTables.tsx # Three compact summary tables (By Article, By Feed, By Date) rendered between KpiSummaryBar and PerformanceTable; groups CombinedRow[] by article slug match / feed_provider_id / stat_date; shows Cost/Profit/ROI pills + 1D-ago/2D-ago historical ROI from historicalRows; loads articles+providers from localStorage; no new API calls
