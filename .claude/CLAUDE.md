...
│   ├── performance/
│   │   ├── PerformanceTable.tsx       # Meta Ads Manager-style table: toolbar (Edit/Delete/Columns/CSV), bulk edit panel, 29 optional metric cols, delivery badge, inline Budget/Bid/Status editing, sort arrows, click name → DrilldownModal; ColumnSelector lives in toolbar; Snapchat logo left of campaign name
