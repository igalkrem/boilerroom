...
// ─── Meta token storage (for Traffic Sources connection status) ────────────
// Meta has no refresh_token. The long-lived access token (~60 days) is stored
// directly, encrypted with the same AES-256-GCM key as Snap tokens.
