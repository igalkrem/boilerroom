...
const HYDRATION_KEYS = [
  ...
  { key: "br_country_groups", storageKey: "boilerroom_country_groups_v1" },
  ...
  { key: "br_page_configs_v1", storageKey: "boilerroom_page_configs_v1" },
  { key: "br_catalogue_v1", storageKey: "boilerroom_catalogue_v1" },
] as const;
